...
fprintf(fid, 'OID, search_box_width, search_box_height, daily_lat_limit, delta_t, date, month, numtemps, mintemp, maxtemp, medtemp, HDF_start_year, HDF_start_day, HDF_end_year, HDF_end_day, lat_SST, lat_light, long, index1_max, max_poss_index1, index1_num_tied, index1_latmin, index1_latmax, index1_latmed, index2_max, max_poss_index2, index2_num_tied, index2_latmin, index2_latmax, index2_latmed, min_index3, index3_num_tied, index3_latmin, index3_latmax, index3_latmed, lat_step, long_step, slope, intercept\r\n');

num_posns = size(SST_posns, 2);
for i = 1:num_posns
	v =	datevec(SST_posns(i).date);
	fprintf(fid, '%d,%d,%d,%.2f,%.2f,%s,%d,%d,%.2f,%.2f,%.2f,%d,%d,%d,%d,%.3f,%.3f,%.3f,%.6f,%.6f,%.3f,%.3f,%.3f,%.3f,%.6f,%.6f,%.3f,%.3f,%.3f,%.3f,%e,%d,%.2f,%.2f,%.2f,%e,%f,%f,%d\r\n', ...
		i, options.search_width, options.search_height, options.delta_lat, options.delta_t, ...
